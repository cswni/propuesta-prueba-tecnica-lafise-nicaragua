    ...
    <div className={cn(
      ...
      <div className="w-full max-w-md sm:max-w-2xl mx-auto text-center">
        ...
        <div className="relative mb-8">
          ...
          {/* Floating Icons */}
          <div className="absolute -top-4 -right-4 bg-blue-500 text-white p-2 sm:p-3 rounded-full shadow-lg" style={{ animationDelay: '0.5s' }}>
            <Wrench className="w-6 h-6"/>
          </div>
          <div className="absolute -bottom-4 -left-4 bg-green-500 text-white p-2 sm:p-3 rounded-full shadow-lg" style={{ animationDelay: '1s' }}>
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            <h1 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent">{title}</h1>
            <p className="text-base sm:text-xl text-slate-600 md:mx-auto leading-relaxed min-h-24">{description}</p>
          </div>

          {/* Progress Bar */}
          <div className="w-full max-w-xs sm:max-w-md mx-auto">
            <div className="bg-slate-200 h-3 overflow-hidden">
              <div className="bg-gradient-to-r from-blue-500 to-green-500 h-full rounded-full animate-pulse" style={{ width: '55%' }}></div>
            </div>
